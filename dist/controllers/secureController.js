...
class SecureController {
    constructor(project) {
        this.executeSecure = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            (0, console_1.info)(`Securing ${this.hostname}...`);
            yield (0, filesystem_1.ensureDirectoryExists)(jale_1.jaleSslPath);
            yield this.unsecure();
            yield this.createSslCertificate();
            this.secureNginxConfig();
            yield (new nginx_1.default()).restart();
            (0, console_1.success)(`${this.hostname} has been secured and is now reachable via ${(0, console_1.url)(`https://${this.hostname}`)}.`);
        });
        this.executeUnsecure = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            if (yield this.unsecure()) {
                (0, console_1.success)(`${this.hostname} has been unsecured and is no longer reachable over https.`);
                yield (new nginx_1.default()).restart();
            }
            (0, console_1.warning)(`The site ${this.hostname} is not secured.`);
            return;
        });
        this.isSecure = () => {
        ...
        this.unsecure = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            if ((0, fs_1.existsSync)(this.crtPath)) {
                (0, fs_1.unlinkSync)(this.csrPath);
                (0, fs_1.unlinkSync)(this.keyPath);
                (0, fs_1.unlinkSync)(this.crtPath);
                (0, fs_1.unlinkSync)(this.configPath);
                yield (0, execa_1.default)('sudo', ['security', 'find-certificate', '-c', this.hostname, '-a', '-Z', '|', 'sudo', 'awk', '\'/SHA-1/{system("sudo security delete-certificate -Z "$NF)}\''], { shell: true, stdio: 'inherit' });
        ...
        this.createSslCertificate = () => tslib_1.__awaiter(this, void 0, void 0, function* () {
            ...
            yield (0, fs_1.writeFileSync)(this.configPath, (0, openssl_1.default)(this.hostname));
            // Generate private key
            yield (0, execa_1.default)('openssl', ['genrsa', '-out', this.keyPath, '2048']);
            ...
            yield (0, execa_1.default)('openssl', ['req', '-new', '-key', this.keyPath, '-out', this.csrPath, '-subj',
                subject, '-config', this.configPath, '-passin', 'pass:']);
            yield (0, execa_1.default)('openssl', ['x509', '-req', '-days', '365', '-in', this.csrPath, '-signkey',
                this.keyPath, '-out', this.crtPath, '-extensions', 'v3_req', '-extfile', this.configPath]);
            // TODO: Make this cross-platform compatible.
            yield (0, execa_1.default)('sudo', ['security', 'add-trusted-cert', '-d', '-r', 'trustRoot', '-k', '/Library/Keychains/System.keychain', this.crtPath]);
        });
        /**
         * Make sure the Nginx config works with SSL.
         */
        this.secureNginxConfig = () => {
            let nginxConfig = (0, fs_1.readFileSync)(`${jale_1.jaleSitesPath}/${this.project}.conf`, 'utf-8');
    ...
    ssl_certificate_key ${this.keyPath};\n`);
            (0, fs_1.writeFileSync)(`${jale_1.jaleSitesPath}/${this.project}.conf`, nginxConfig);
        };
        /**
